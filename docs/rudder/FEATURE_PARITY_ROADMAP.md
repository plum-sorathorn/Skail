# Rudder core feature acceptance matrix and follow-on roadmap

Status: Active
Date: 2026-09-13
Authority: [ADR 0006](../decisions/0006-adaptive-execution-and-release-boundaries.md),
[feature contracts](FEATURES.md), and the
[adaptive orchestration and release guide](../../tasks/rudder-adaptive-orchestration-and-release-plan.md)

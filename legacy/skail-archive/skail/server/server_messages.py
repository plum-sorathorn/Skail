...
async def handle_messages(
    ...
    *,
    ...
    try:
        ...
        try:
            from skail.config import resolve_orchestrator_model as _resolve_model
            import skail.config as _cfg_mod
        ...
        try:
            ...
            _logging.getLogger("skail").warning("route_target failed, fail-soft degrade: %s", exc)
        except Exception:
            pass
    ...
    if extra.get("_oma_result"):
        ...
        try:
            from skail.stats import record_oma_outcomes
    ...
    if extra.get("_path") == "FAST":
        try:
            from skail.digest import maybe_digest_messages
    ...
    if body.stream:
        try:
            ...
            from skail.routing.pricing import record_error
            record_error(target)
            return JSONResponse(
                {
                    "type": "error",

...
from skail.stats import SUPPORTED_WINDOWS, aggregate, aggregate_scopes, filter_records, load_records
...
async def handle_models(serve_model_ids: Any) -> dict[str, Any]:
    ...
    return {
        "object": "list",
        "data": [
            {"id": m, "object": "model", "owned_by": "skail"}
...
async def handle_stats(
    ...
    *,
    ...
    try:
        from skail.routing.benchmarks import snapshot_status

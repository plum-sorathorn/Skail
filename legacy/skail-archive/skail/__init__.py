...
def _register_lazy_aliases():
    ...
    so `import skail.<name>` / `from skail.<name> import X` resolve
    ...
    sys.modules and break its own submodule resolution (e.g. skail.server
    importing skail.server.server_streaming).
    """

"""SLM model catalog and downloader for Skail onboarding and runtime."""
...
def get_default_models_dir() -> Path:
    ...
    models_dir = Path.home() / ".skail" / "models"
...
def integrate_slm_model(identifier: str, target_dir: Path | None = None) -> str:
    """Integrate chosen SLM model into the Skail configuration."""
    cfg = get_config()
    info = get_slm_model_info(identifier)
    if not info:
        return ""

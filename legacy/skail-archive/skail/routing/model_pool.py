...
from skail.presets.model_presets import PRESETS
...
class ModelPool:
    ...
    def __init__(self, config: Config, benchmarks: Any = None) -> None:
        ...
        if benchmarks is None:
            from skail.routing.benchmarks import get_registry
    ...
    def select_by_sla_detailed(
        self, sla: CapabilitySLA, pseudo_model: str = "skail"
    ) -> SelectionInfo:
    ...
    def _select(self, sla: CapabilitySLA, pseudo_model: str) -> tuple[str, SelectionInfo]:
        ...
        if sla.domain or sla.role:
            from skail.routing.benchmarks import profile_for

...
def resolve_slm_path(model_path: str = "", config: Any = None) -> str:
    ...
    # Check ~/.skail/<candidate>
    ad_home = Path.home() / ".skail" / candidate
...
# Skail sits in front of many out-of-our-control coding-agent harnesses
...
class SLMPlanner:
    ...
    def _raw_infer(self, messages: list[dict[str, Any]], config: Any = None) -> str | dict[str, Any]:
        ...
        from skail._compat.outlines_fallback import generate_structured_json
        prompt = (

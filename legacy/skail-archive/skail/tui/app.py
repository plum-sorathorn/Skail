...
if _TEXTUAL:
    ...
    class SkailApp(App):
        ...
        def on_mount(self):
            try:
                from skail.launcher import ensure_server
        ...
        def action_quit(self):
            try:
                from skail.launcher import stop_server
                from skail.config import get_config
    ...
    class SkailApp(App):
        def __init__(self, *args, **kwargs): raise RuntimeError("Textual is required to use the Skail TUI")

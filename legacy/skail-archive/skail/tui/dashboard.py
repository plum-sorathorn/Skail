...
from skail.tui.dashboard_screens import (
    DrillDownScreen,
    LaunchAgentScreen,
    UpdateCatalogScreen,
    UpdateScreen,
...
from skail.tui.keymap import FOOTER_HINT
...
if _TEXTUAL:
    class MainMenuScreen(Screen):
        ...
        DUCK_FRAMES = [
            '  __(o<   [bold cyan]Skail[/bold cyan]',
            '  __(.<   [bold cyan]Skail[/bold cyan]',
            '  __(^<   [bold cyan]Skail[/bold cyan]',
        ]
        ...
        MENU_ITEMS = [
            ...
            ("u", "Check for Updates", "Check latest version & upgrade Skail"),
    ...
    class DashboardScreen(Screen):
        ...
        DUCK_FRAMES = [
            '  __(o<   [bold cyan]Skail[/bold cyan] . [green]proxy active[/green]',
            '  __(.<   [bold cyan]Skail[/bold cyan] . [green]proxy active[/green]',
            '  __(^<   [bold cyan]Skail[/bold cyan] . [green]proxy active[/green]',
        ]
        ...
        def _graph_view(self) -> str:
            ...
            model = active.get("selected_model", "skail")
            ...
            if is_active:
                ...
                lines = [
                    f"Engine: [bold]Skail v{__version__}[/bold]",

...
async def start_task(
    ...
    *,
    ...
    if getattr(plugins_cfg, "workflow_enabled", False):
        try:
            from skail.plugin.workflows import TaskPlan, workflow_store
    ...
    model_name = model or (getattr(cfg, "pseudo_model", "skail") if cfg else "skail")
    ...
    if workflow is not None:
        try:
            ...
            from skail.plugin.workflows import workflow_store

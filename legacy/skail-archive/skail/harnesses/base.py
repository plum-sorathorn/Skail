...
BEGIN_MARKER = "# BEGIN SKAIL — do not edit between these markers"
END_MARKER = "# END SKAIL"
...
class BaseAdapter(ABC):
    ...
    def revert(self) -> None:
        # restore most recent backup per path, else remove SKAIL block / JSON keys
        dest_dir = backups_dir(self.id)
        restored = False
        if dest_dir.exists():
        ...
        # no backup: strip blocks from text files, or clean skail key from JSON files
        import json

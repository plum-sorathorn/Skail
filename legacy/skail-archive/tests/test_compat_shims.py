"""Unit tests for skail._compat fallback shims."""
...
def test_multi_slm_catalog_support():
    ...
    from skail.routing.slm_downloader import SLM_MODELS_CATALOG, get_slm_model_info
...
def test_onnx_direct_model_chatml_and_fallback_template():
    ...
    from skail._compat.onnx_fallback import ONNXModelFallback

"""End-to-End Modernization Simulation Suite for Skail 0.3.0.
...
def test_e2e_models_endpoint_listing(api_client: TestClient):
    ...
    assert "skail" in model_ids
    assert "skail-budget" in model_ids
    assert "skail-expensive" in model_ids

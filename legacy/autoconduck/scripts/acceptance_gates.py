...
def _isolate(tmp_home: Path):
    """Reset singletons for isolation. Must be called after setting AUTOCONDUCK_HOME."""
    ...
    import autoconduck.server.server_streaming as ss
...
def gate3_parity() -> tuple[bool, str]:
    ...
    from autoconduck.plugin.bias import reset_bias_singleton, get_bias_store
...
def gate4_fail_soft(tmp_home: Path) -> tuple[bool, str]:
    ...
    try:
        ...
        try:
            ...
            import autoconduck.config as _cfg2
        ...
        r_chat = client.post("/v1/chat/completions", json={"model": "autoconduck", "messages": [{"role": "user", "content": "hello"}], "stream": False}, headers={"x-autoconduck-session-id": "sess-4a"})
        ...
        try:
            import autoconduck.config as _cfg3
        ...
        gate4a_ok = False
        try:
            import autoconduck.plugin.ledger as _lm2
            import autoconduck.config.manager as _mm2
            _mm2._config = None
    ...
    try:
        ...
        cfg_path = tmp_home / ".autoconduck" / "config.yaml"
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        orig_home = os.environ.get("AUTOCONDUCK_HOME")
        os.environ["AUTOCONDUCK_HOME"] = str(tmp_home)
        ...
        try:
            ...
            pass
        print("=" * 72)
        print("AutoConduck Phase 6 - Acceptance Gates (offline)")
        ...
        if orig_home is None:
            os.environ.pop("AUTOCONDUCK_HOME", None)
        else:
            os.environ["AUTOCONDUCK_HOME"] = orig_home
        try:

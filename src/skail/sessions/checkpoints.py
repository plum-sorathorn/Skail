...
class CheckpointStore:
    """Skail correlation metadata stored beside, but separate from, the journal."""
    ...
    def initialize(self) -> None:
        ...
        try:
            connection.execute(
                "CREATE TABLE IF NOT EXISTS skail_checkpoint_refs ("
    ...
    def locked(self, session_id: str) -> Iterator[None]:
        ...
        lock_path = self.path.parent / f".skail-session-{digest}.lock"

...
from rudder.cli.exit_codes import EXIT_FAILURE, EXIT_OK, EXIT_USAGE
from rudder.cli.render import render_print_stderr, render_print_stdout
from rudder.config.loader import ResolvedConfig, load_config
...
from rudder.sessions.export import SessionExporter
...
def handle_auth(args: Namespace) -> int:
    ...
    render_print_stdout("Rudder Provider Credentials Status:")

...
**Rudder** is a native, budget-aware multi-agent coding harness for Python 3.12+. It launches directly from the console as `rudder` without proxy servers, daemons, plugin planes, or hook shims.
